...
CREATE TABLE IF NOT EXISTS `sduty`.`alarm` (
  ...
  `alarm_cron` CHAR(50) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sduty`.`user` (
  ...
  `user_password2` CHAR(60) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sduty`.`story` (
  ...
  `story_contents` VARCHAR(140) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sduty`.`interest_hashtag` (
  `interest_hashtag_name` VARCHAR(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sduty`.`job_hashtag` (
  `job_hashtag_name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sduty`.`study` (
  ...
  `study_introduce` VARCHAR(100) NULL DEFAULT NULL,
  `study_category` VARCHAR(45) NOT NULL,
  `study_join_number` INT NOT NULL DEFAULT '1',
  `study_limit_number` INT NOT NULL DEFAULT '2',
  `study_password` VARCHAR(45) NULL DEFAULT NULL,
  `study_room_id` CHAR(70) NULL DEFAULT NULL,
  `study_regtime` TIMESTAMP NOT NULL,
  `study_notice` CHAR(200) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sduty`.`reply` (
  ...
  `reply_content` VARCHAR(140) NOT NULL,
