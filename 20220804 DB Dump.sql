...
INSERT INTO `achievement` VALUES (0,'Senior','Study Senior',0),(1,'Starter','Study Starter',0),(2,'Junior','Study Junior',0);
...
INSERT INTO `follow` VALUES (11,10),(10,11),(10,49);
...
INSERT INTO `image` VALUES (1,'story/1659579346960.png','/home/ubuntu/S07P12D108/Sduty_Server/src/main/resources/image/story/');
...
INSERT INTO `interest_hashtag` VALUES (0,'테스트'),(1,'수능');
...
CREATE TABLE `job` (
  ...
  KEY `job_hashtag_seq_idx` (`job_hashtag_seq`),
  CONSTRAINT `job_hashtag_seq` FOREIGN KEY (`job_hashtag_seq`) REFERENCES `job_hashtag` (`job_hashtag_seq`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `job_hashtag` (
  `job_hashtag_seq` int NOT NULL,
  `job_hashtag_name` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `job_hashtag` VALUES (0,'테스터'),(1,'학생');
...
INSERT INTO `story` VALUES (2,2,'123','123','2022-08-04 12:19:22',2,0,'chamjjeol',1,1),(3,2,'555555555','555555555555555123','2022-08-04 12:19:51',2,0,'mwajjeol',1,1),(4,2,'12323131','412412244','2022-08-04 12:20:32',2,0,'bbibjjeol',1,1);
...
-- Dump completed on 2022-08-04 12:54:58
