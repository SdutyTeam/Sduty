...
CREATE TABLE IF NOT EXISTS `sduty`.`qna` (
  ...
  `ques_user_seq` INT NULL DEFAULT NULL,
  `ques_title` VARCHAR(50) NULL DEFAULT NULL,
  `ques_content` VARCHAR(50) NULL DEFAULT NULL,
  `ques_writer` VARCHAR(30) NULL DEFAULT NULL,
  `ans_writer` VARCHAR(30) NULL DEFAULT NULL,
